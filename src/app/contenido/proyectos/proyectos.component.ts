...
=======
    { nombre: 'Analizador de texto', enlace: 'https://yamilethreveca.github.io/DEV012-text-analyzer/', imagen: '../../../assets/image/proyecto_analisis-de-texto.png', summary: 'Analiza texto y proporciona métricas, nos permite medir las palabras, caracteres,suma, números entre otros.' },
    { nombre: 'DataVerse', enlace: 'https://yamilethreveca.github.io/DEV012-dataverse/', imagen: '../../../assets/image/proyecto_pokemon-removebg-preview.png', summary: 'Explora datos sobre Pokémon, podemos filtrar y ordenar según el elemento del pokémon.' },
    { nombre: 'Dataverse Chat con IA', enlace: 'https://dataverse-chat.vercel.app/', imagen: '../../../assets/image/proyecto_IA.jpg', summary: 'Interacción con IA de OpenAI para conversar con los personajes de One Piece.' },
    { nombre: 'Movie Challenge con Angular', enlace: 'https://movie-challenge-con-framework.vercel.app/', imagen: '../../../assets/image/movie.jpg', summary: 'Mostar listado de peliculas, filtrar por genero y ordenar por: popularidad, fecha de estreno o por votación, todo a través de la api de TMDB.' },
>>>>>>> 81aafea (arreglando portafolio)
